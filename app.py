...
st.info("Developed under ** Virtual Internship** by **Upflairs Pvt Ltd**, Domain: Data Science in AI/ML", icon="🎓")
st.markdown("🔗 [LinkedIn](https://www.linkedin.com/in/sidra-hussain123/)  |  📧 hsidra10@gmail.com")
...
# ---------- Footer ----------
st.markdown("<div class='footer'>✨ Crafted with 💻 by <b>Sidra Hussain</b> | 📧 hsidra10@gmail.com | 🌐 <a href='https://www.linkedin.com/in/sidra-hussain123/' style='color:#82b1ff;'>LinkedIn</a></div>", unsafe_allow_html=True)
